#!/usr/bin/env python3
'''
Written by: Joshua Lee, Date: 2/26/24

This script goes through the vision pipeline to find the closest color of a specific block. It takes in the colors that it should
search through listens to the camera topic (realsense) to get the image, and publishes the pose relative to the camera + robot ?

Hopefully, there is some optimization to make sure the block returned is in fact the closest block. 
...
from me326_project.srv import Ptps
import cv2 as cv
