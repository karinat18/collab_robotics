...
#include "locobot_interfaces/action/move_arm.hpp"
...
{
public:
  using ActionMoveArm = locobot_interfaces::action::MoveArm;
...
//   // Create the MoveIt MoveGroup Interface
//   using moveit::planning_interface::MoveGroupInterface;
//   auto move_group_interface = MoveGroupInterface(move_group_node, "interbotix_arm");
