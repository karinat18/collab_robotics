...
class Metaclass_MoveBase_Goal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('locobot_autonomy')
        except ImportError:
            import logging
            import traceback
            logger = logging.getLogger(
                'locobot_autonomy.action.MoveBase_Goal')
            logger.debug(
...
class Metaclass_MoveBase_Result(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'locobot_autonomy.action.MoveBase_Result')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_MoveBase_Feedback(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'locobot_autonomy.action.MoveBase_Feedback')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class MoveBase_SendGoal_Request(metaclass=Metaclass_MoveBase_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'locobot_autonomy/MoveBase_Goal',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['locobot_autonomy', 'action'], 'MoveBase_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from locobot_autonomy.action._move_base import MoveBase_Goal
...
class Metaclass_MoveBase_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'locobot_autonomy.action.MoveBase_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from locobot_autonomy.action import _move_base
...
class MoveBase_SendGoal(metaclass=Metaclass_MoveBase_SendGoal):
    from locobot_autonomy.action._move_base import MoveBase_SendGoal_Request as Request
    from locobot_autonomy.action._move_base import MoveBase_SendGoal_Response as Response
...
class MoveBase_GetResult_Response(metaclass=Metaclass_MoveBase_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'locobot_autonomy/MoveBase_Result',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('int8'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['locobot_autonomy', 'action'], 'MoveBase_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from locobot_autonomy.action._move_base import MoveBase_Result
...
class Metaclass_MoveBase_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'locobot_autonomy.action.MoveBase_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class MoveBase_GetResult(metaclass=Metaclass_MoveBase_GetResult):
    from locobot_autonomy.action._move_base import MoveBase_GetResult_Request as Request
    from locobot_autonomy.action._move_base import MoveBase_GetResult_Response as Response
...
class Metaclass_MoveBase_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'locobot_autonomy.action.MoveBase_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class MoveBase_FeedbackMessage(metaclass=Metaclass_MoveBase_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'locobot_autonomy/MoveBase_Feedback',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['locobot_autonomy', 'action'], 'MoveBase_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from locobot_autonomy.action._move_base import MoveBase_Feedback
...
class Metaclass_MoveBase(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'locobot_autonomy.action.MoveBase')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class MoveBase(metaclass=Metaclass_MoveBase):
    ...
    from locobot_autonomy.action._move_base import MoveBase_Goal as Goal
    # The result message defined in the action definition.
    from locobot_autonomy.action._move_base import MoveBase_Result as Result
    # The feedback message defined in the action definition.
    from locobot_autonomy.action._move_base import MoveBase_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from locobot_autonomy.action._move_base import MoveBase_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from locobot_autonomy.action._move_base import MoveBase_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from locobot_autonomy.action._move_base import MoveBase_FeedbackMessage as FeedbackMessage
